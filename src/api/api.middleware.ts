...
export const useLogin = (
  { method, url, headers, timeout, callbackWhenError }: IApiRequest,
  funcRequest: State,
) => {
  return useMutation(
    async (data: any) =>
      await requestApiLogin({ method, url, payload: data, headers, timeout }),
    {
      onSuccess: (data) => {
        console.log(data);
        ResponseCode.find(data, funcRequest);
...
export const useLogout = (
  ...
  return useMutation(
    async (data: any) =>
      await requestApi({ method, url, payload: data, headers }),
    {
      onSuccess: (data) => {
        ResponseCode.find(data, funcRequest);
      },
